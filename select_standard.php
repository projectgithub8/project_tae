					...
					<table class="table table-striped table-bordered table-hover">
						...
						<tbody>
							...
							<tr>
								...
								<td><center><?php echo "<a href='delete_standard.php?id=".$crow['id']."' onclick='return confirm(\"คุณต้องการที่จะลบข้อมูลนี้หรือไม่ ?\")'><img src='deletee.png' width='20px' height='20px'></a></td></a>"; ?></td>
							</tr>
							<?php
							$i++;
									}
